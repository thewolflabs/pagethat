...
//        logout();
        ...
        oauthRedirectURL = "http://thewolflabs.in/pagethat/oauthcallback.html";
        ...
        if (runningInCordova) {
			...
			loginWindow.addEventListener('loaderror', function(event) { alert('error: ' + event.message); });
        }
    ...
    function api(obj) {
        ...
        var method = obj.method || 'GET',
            ...
            url;
        //alert(tokenStore['fbtoken']);

        params['access_token'] = 'CAAFC3msn3pABAGqI2Yq2ZAPmDaXjaJ3DuGbdrDpFq3E26vC43Y0uOyeyP0KJ9aRlxpekelcB1gsvadGL9qKH66OL9UJUeS1liis5Lia1Qx0u0ZAGNxMnrkx1tu1iBsw00lm1RDtKeTOkzuFix7N5upXKZCB3Hhes1dIhcZA8fa1d8tdJndO00OSTDeirWkunFSqukticn5NPNki0xKCm';
            //tokenStore['fbtoken'];
        //alert('api');
